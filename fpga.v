...
reg [17:0] drivers_3_vc_estimate;
reg [35:0] drivers_3_sum_of_products;
reg [13:0] drivers_3_things_4___out;
reg signed [35:0] drivers_3_things_0_interp_step;
reg signed [35:0] drivers_3_things_0_interp_data;
...
always @(posedge fastclk, posedge reset) begin: FPGA_DRIVERS_3_THINGS_0_DO_STUFF
    if (reset) begin
        ...
        if (clk) begin
            drivers_3_things_0_interp_data <= (drivers_3_things_0_delay_1 << 22);
        ...
        else if (((drivers_3_things_0_interp_data + drivers_3_things_0_interp_step) < -34359738368)) begin
            drivers_3_things_0_interp_data <= -34359738368;
        end
        else if (((drivers_3_things_0_interp_data + drivers_3_things_0_interp_step) >= 34359738368)) begin
            drivers_3_things_0_interp_data <= (34359738368 - 1);
        end
        else begin
...
assign drivers_3_interp_result = $signed(drivers_3_things_0_interp_data >>> 22);
...
always @(posedge fastclk, posedge reset) begin: FPGA_DRIVERS_3_DO_STUFF
    if (reset) begin
        ...
        drivers_3_vc_estimate <= (1 << 17);
    end
    else begin
        drivers_3_dac_bit_internal <= (drivers_3_interp_result_unsigned > (drivers_3_sum_of_products >>> (36 - 14)));
        drivers_3_vc_estimate <= (drivers_3_sum_of_products >>> 18);
    end
end
...
always @(drivers_3_dac_bit_internal, drivers_3_vc_estimate) begin: FPGA_DRIVERS_3_MULTIPLY
    if (drivers_3_dac_bit_internal) begin
        drivers_3_sum_of_products = ((818 << 18) + (261326 * drivers_3_vc_estimate));
    end
    else begin
        drivers_3_sum_of_products = (261326 * drivers_3_vc_estimate);
    end
end
